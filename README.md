...
Given a .klg log file containing frames acquired from a Kinect One V2, use *./ElasticFusion -l your_log_file.klg -width 960 -height 540 -cal ../config/kinect2_cal.txt -f -tf fileprefix*.
